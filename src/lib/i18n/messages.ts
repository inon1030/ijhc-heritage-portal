...
export const en = {
  ...
  'upload.scan.button': "Scan with your phone's camera",
  'upload.scan.hint': "Photograph each page flat and in good light. After every page you choose: another page of the same document, or a separate document.",
  'upload.scan.onComputer': "On a computer? Scan this with your phone to open this page there.",
  ...
  'upload.scan.working': "Preparing the page…",
