...
export const en = {
  ...
  'theme.change': 'Change the appearance',
  'theme.system': 'System',
  'theme.light': 'Light',
  'theme.dark': 'Dark',
  'legal.englishOnly': "This document is written in English and Hebrew only. A machine translation of a legal undertaking is not an undertaking, so the English is shown here.",
  'legal.contactHeading': "Whom to write to",
  'nav.privacy': "Privacy",
  'nav.terms': "Terms of use",
  'nav.accessibility': "Accessibility",
  'stats.heading': "Visitor statistics",
  'stats.body': "May the Center count visits to this archive, to see which records people look for? Nothing you send is measured, and saying no changes nothing you can do here.",
  'stats.accept': "Allow",
  'stats.decline': "No thanks",
  ...
  'guides.admin.locked': "This guide is for administrators of the archive.",
  'guides.fullGuide': "The full guide",
  'guides.fullGuideHint': "Every screen, with the places to click marked. Opens in a new tab.",
  'guides.videos': "Videos",
  'guides.scanning': "Scanning with your phone",
  'guides.scanningHint': "How to photograph a page so the archive can read it, in Hebrew.",
  'guides.pdfHebrew': "Hebrew",
  'guides.pdfEnglish': "English",
  'guides.step': "Step {current} of {total}",
  'guides.back': "Back",
  'guides.next': "Next",
  'guides.allSteps': "All steps",
  'guides.mode.label': "How much to learn",
  'guides.mode.quick': "Quick learning",
  'guides.mode.quickHint': "The steps that matter, a few minutes",
  'guides.mode.deep': "In depth",
  'guides.mode.deepHint': "Every screen and every option",
  'guides.quickGuide': "The short guide",
  ...
  'scan.kept': "{count} kept",
  'scan.done': "Done",
  'scan.loading': "Opening the camera…",
  'scan.noCamera': "The browser did not give access to the camera. You can take the photo with the phone’s camera instead, and it will be cropped and cleaned the same way.",
  'scan.takePhoto': "Take a photo",
  'scan.preview': "The scanned page",
  'scan.look.document': "Document",
  'scan.look.bw': "Black and white",
  'scan.look.photo': "Photo",
  'scan.corners': "Adjust corners",
  'scan.rotate': "Turn the page",
  'scan.retake': "Retake",
  'scan.keep': "Keep this page",
  'scan.fromGallery': "From the gallery",
  'scan.shoot': "Scan the page",
  'scan.auto': "Auto edges",
  'upload.scan.button': "Smart scan with the camera",
  'upload.scan.hint': "Point the phone at a page, a photograph or a letter. The edges are found for you, the page is straightened and cleaned, and you can scan several pages into one document or start a separate one.",
  'upload.scan.document': "Document {n}",
  'upload.scan.onePage': "1 page",
  'upload.scan.pages': "{count} pages",
  'upload.scan.pageAlt': "Page {n}",
  'upload.scan.removePage': "Remove page {n}",
  'upload.scan.addPageShort': "Another page",
  'upload.scan.addPage': "Scan another page of this document",
  'upload.scan.newDocument': "Scan a separate document",
  'upload.scan.docTitle': "Scanned document {n}",
  'prereview.record': "Item {n}",
  'prereview.recordPages': "Item {n} · {count} pages",
  ...
  'wb.readingPending': "The item was sent before the AI finished reading it. The reading is still running in the background. Refresh in a minute or two to see it.",
  ...
  'flow.slow.alone': "Send now, read in the background",
  'upload.done.bodyAlone': "It went straight to a Knowledge Expert. The AI is still reading it in the background, and the expert will see the reading when it is done.",
  'upload.link.hint': 'An article, a blog post, or a YouTube video. The archive keeps a copy of the text and the picture rather than only the address, because pages disappear.',
  'wb.moveToBin': 'Move to the bin',
  'wb.moveToBinConfirm': 'Move “{title}” to the bin? An administrator can restore it from there.',
  'wb.decisionNote': 'Rejecting keeps the record for the archive team and removes it from the public portal; it can be returned to the queue later. Moving to the bin takes the record out of the queue, and only an administrator can restore it or destroy it for good.',
  'wb.reject': 'Reject',
